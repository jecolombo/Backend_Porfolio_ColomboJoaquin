...
import com.portfolio.Colombo.Dto.dtoPersona;
import com.portfolio.Colombo.Entity.Persona;
import com.portfolio.Colombo.Security.Controller.Mensaje;
import com.portfolio.Colombo.Service.ImpPersonaService;
...
public class PersonaController {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoPersona dtopersona) {
        ...
        persona.setPortada(dtopersona.getPortada());
